...
write_html(raw_data,paste0("R/inputs/data/EightOunce/Detour_" ,rundate, ".html"))
...
for(i in URLs){
  ...
  #save the htmls
  write_html(coffee_row,paste0("R/inputs/data/EightOunce/Coffees/Detour_", cnt, "_" ,rundate, ".html"))
