...
#### Preamble ####
# Purpose: The purpose of this script is to download all of the coffees by The Library on EightOunceCoffee.ca
...
xml2::write_html(raw_data,paste0("R/inputs/data/EightOunce/TLS_" ,rundate, ".html"))
...
hypenated_data$URL <- paste0("https://eightouncecoffee.ca/collections/the-library-specialty-coffee/products/",hypenated_data[,1])
...
for(i in URLs){
  ...
  #save the htmls
  xml2::write_html(coffee_row,paste0("R/inputs/data/EightOunce/Coffees/TLS_", cnt, "_" ,rundate, ".html"))
